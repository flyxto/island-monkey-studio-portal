    ...
    <div className="space-y-8 max-w-7xl mx-auto">
      ...
      <div className="space-y-4">
        <div className="flex items-center gap-2">
          ...
          <h2 className="text-lg font-bold text-slate-900">Pending Gigs</h2>
        </div>
            ...
            {model.pendingGigs.map((gig) => (
              <Card key={gig.id} className="bg-white border-slate-200 shadow-xs overflow-hidden hover:shadow-md transition-shadow">
                <div className="relative h-48 w-full">
                  ...
                  <span className="absolute top-3 left-3 bg-amber-500 text-white text-[11px] font-bold px-3 py-1 rounded-full shadow-md">
                    Pending Approval
                  </span>
                </div>
                <CardContent className="p-6 space-y-4">
                  <div>
                    <h3 className="text-base font-bold text-slate-900">{gig.title}</h3>
      ...
      <div className="space-y-4">
        <div className="flex items-center gap-2">
          ...
          <h2 className="text-lg font-bold text-slate-900">Active Gigs</h2>
        </div>
